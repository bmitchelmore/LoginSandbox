...
private func file() -> WritingHandle {
    let path = try! FileManager.default.url(for: .documentDirectory, in: .userDomainMask, appropriateFor: nil, create: true).appending(component: "peer-advertiser.log")
...
private let queue = DispatchQueue(label: "ca.burea.labs.peer-advertiser.logger")
