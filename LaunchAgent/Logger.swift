...
private func file() -> WritingHandle {
    let path = try! FileManager.default.url(for: .documentDirectory, in: .userDomainMask, appropriateFor: nil, create: true).appending(component: "login-sandbox-launch-agent.log")
